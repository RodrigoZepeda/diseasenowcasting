...
We annotate the data with
[`tbl_now()`](https://rodrigozepeda.github.io/tbl.now/reference/tbl_now.html),
pointing at the event and report dates (here the symptom-onset and
report weeks) and the strata (`gender`):
...
(bars show the median, error bars the 90% credible interval) and
extracted with [`predict()`](https://rdrr.io/r/stats/predict.html) /
...
![\_Nowcast for the dengue example, by
gender.\_](reference/figures/README-plot-1.png)
...
California.\_](reference/figures/README-flusight-1.png)
...
to change the prior. For several locations at once, declare the location
column as `strata`: a single stratified
[`nowcast()`](https://rodrigozepeda.github.io/diseasenowcasting/reference/nowcast.md)
...
Any
[`model()`](https://rodrigozepeda.github.io/diseasenowcasting/reference/model.md)
completely separates the **epidemic** and the **delay** processes
allowing the user to specify the process governing each of them. When
one specifies
...
![Image showing how a nowcast can be decomposed into the epidemic and
delay processes](reference/figures/nowcasting_panels_resized.svg)

In `diseasenowcasting`, the
[`nowcast_diagnostic()`](https://rodrigozepeda.github.io/diseasenowcasting/reference/nowcast_diagnostic.md)
function plots these processes separately so you can see the
reconstructed epidemic and delay processes fitted to the data:
...
`diseasenowcasting` framework via the
[`custom_delay()`](https://rodrigozepeda.github.io/diseasenowcasting/reference/custom_delay.md)
and
[`custom_epidemic()`](https://rodrigozepeda.github.io/diseasenowcasting/reference/custom_epidemic.md)
functions. You can see more in the [Custom delays and epidemic processes
...
which walks through building a `tbl_now`, fitting with
[`nowcast()`](https://rodrigozepeda.github.io/diseasenowcasting/reference/nowcast.md),
