...
#include "stanExports_generated_quantities_discrete.h"

RCPP_MODULE(stan_fit4generated_quantities_discrete_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_generated_quantities_discrete")
