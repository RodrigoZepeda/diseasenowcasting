...
// state_space_process
Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>,                 stan::base_type_t<double>, stan::base_type_t<double>,                 stan::base_type_t<double>, stan::base_type_t<double>,                 stan::promote_args_t<stan::base_type_t<double>, double, double,                   stan::base_type_t<double>, stan::base_type_t<double>,                   stan::promote_args_t<stan::base_type_t<double>,                     stan::base_type_t<double>, double, double, double,                     stan::promote_args_t<double, stan::base_type_t<double>,                       stan::base_type_t<double>, stan::base_type_t<double>,                       stan::base_type_t<double>,                       stan::promote_args_t<stan::base_type_t<double>>>>>>,-1,-1> state_space_process(const int& num_steps, const int& num_delays, const int& num_strata, const Eigen::Matrix<double,-1,-1>& A_mu, const Eigen::Matrix<double,-1,-1>& A_nu, const Eigen::Matrix<double,-1,-1>& R_mu, const Eigen::Matrix<double,-1,-1>& R_nu, const Eigen::Matrix<double,-1,1>& L_mu, const Eigen::Matrix<double,-1,1>& L_nu, const std::vector<Eigen::Matrix<double,-1,-1>>& xi_mu_centered, const std::vector<Eigen::Matrix<double,-1,-1>>& xi_nu_centered, const Eigen::Matrix<double,-1,1>& xi_mu_sd, const Eigen::Matrix<double,-1,1>& xi_nu_sd, const Eigen::Matrix<double,-1,-1>& mu_0_centered, const Eigen::Matrix<double,-1,-1>& nu_0_centered, const double& mu_0_sd, const double& nu_0_sd, const double& mu_0_mean, const double& nu_0_mean, const Eigen::Matrix<double,-1,1>& B_cnt, const Eigen::Matrix<double,-1,-1>& X_cnt, const Eigen::Matrix<double,-1,1>& phi_AR, const Eigen::Matrix<double,-1,1>& theta_MA, const Eigen::Matrix<double,-1,-1>& xi, std::ostream* pstream__);
