...
#include "stanExports_nowcast_discrete.h"

RCPP_MODULE(stan_fit4nowcast_discrete_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_nowcast_discrete")
