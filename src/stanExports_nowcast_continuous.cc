...
#include "stanExports_nowcast_continuous.h"

RCPP_MODULE(stan_fit4nowcast_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_nowcast_continuous")
