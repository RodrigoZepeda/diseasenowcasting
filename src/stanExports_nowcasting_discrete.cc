...
#include "stanExports_nowcasting_discrete.h"

RCPP_MODULE(stan_fit4nowcasting_discrete_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_nowcasting_discrete")
