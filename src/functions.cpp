...
namespace model138966e72d323_User_defined_functions_namespace {
...
count_cases(const std::vector<std::vector<int>>& case_idx, const int&
  ...
  return model138966e72d323_User_defined_functions_namespace::count_cases(
...
mean_cases(const std::vector<double>& cases_real,
           ...
           num_strata, const int& num_delays, const int& n_rows, const int&
           d_col, const int& s_col, std::ostream* pstream__ = 0) {
  return model138966e72d323_User_defined_functions_namespace::mean_cases(
...
sd_cases(const std::vector<double>& cases_real,
         ...
         num_strata, const int& num_delays, const int& n_rows, const int&
         d_col, const int& s_col, std::ostream* pstream__ = 0) {
  return model138966e72d323_User_defined_functions_namespace::sd_cases(
           cases_real, case_idx, num_strata, num_delays, n_rows, d_col,
           s_col, pstream__);
}
// [[Rcpp::export]]
...
normalize_cases(const std::vector<double>& cases_real,
                ...
                pstream__ = 0) {
  return model138966e72d323_User_defined_functions_namespace::normalize_cases(
           cases_real, case_idx, num_strata, num_delays, n_rows, d_col,
...
inv_normalize_cases(const std::vector<double>& normalized,
                    ...
                    const Eigen::Matrix<double,-1,-1>& sigma, std::ostream*
                    pstream__ = 0) {
  return model138966e72d323_User_defined_functions_namespace::inv_normalize_cases(
