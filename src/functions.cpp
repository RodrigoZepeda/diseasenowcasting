...
namespace model1022a2e47765_User_defined_functions_namespace {
...
static constexpr std::array<const char*, 121> locations_array__ =
  ...
  " (in 'User-defined functions', line 349, column 10 to column 16)",
  " (in 'User-defined functions', line 349, column 4 to column 29)",
  " (in 'User-defined functions', line 351, column 6 to column 94)",
  " (in 'User-defined functions', line 350, column 4 to line 351, column 94)",
  " (in 'User-defined functions', line 352, column 4 to column 17)",
  " (in 'User-defined functions', line 348, column 23 to line 353, column 1)"};
...
// [[Rcpp::export]]
 int  max_int(const int& a, const int& b, std::ostream* pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::max_int(a, b,
           pstream__);
}
// [[Rcpp::export]]
 int  min_int(const int& a, const int& b, std::ostream* pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::min_int(a, b,
           pstream__);
}
// [[Rcpp::export]]
...
AR(const Eigen::Matrix<double,-1,-1>& y, const Eigen::Matrix<double,-1,1>&
  ...
  return model1022a2e47765_User_defined_functions_namespace::AR(y, phi, t, p,
           pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>,                 stan::base_type_t<double>>,-1,1> 
MA(const Eigen::Matrix<double,-1,-1>& xi, const Eigen::Matrix<double,-1,1>&
  ...
  return model1022a2e47765_User_defined_functions_namespace::MA(xi, theta, t,
           q, pstream__);
}
// [[Rcpp::export]]
...
create_phi_AR(const Eigen::Matrix<double,-1,1>& phi, std::ostream*
              pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::create_phi_AR(
           phi, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
create_theta_MA(const Eigen::Matrix<double,-1,1>& theta, std::ostream*
                pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::create_theta_MA(
           theta, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>,                 stan::base_type_t<double>>,-1,-1> 
create_block_diagonal(const Eigen::Matrix<double,-1,-1>& A,
                      ...
                      pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::create_block_diagonal(
           A, B, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,-1> 
rep_diagonal_mat(const Eigen::Matrix<double,-1,-1>& A, const int& k,
  ...
  return model1022a2e47765_User_defined_functions_namespace::rep_diagonal_mat(
           A, k, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
rep_vec(const Eigen::Matrix<double,-1,1>& A, const int& k, std::ostream*
        pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::rep_vec(A, k,
           pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
rep_vec_piecewise(const Eigen::Matrix<double,-1,1>& A, const int& k,
                  std::ostream* pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::rep_vec_piecewise(
           A, k, pstream__);
}
// [[Rcpp::export]]
...
append_val_2_vec(const Eigen::Matrix<double,-1,1>& A, const double& val,
                 std::ostream* pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::append_val_2_vec(
           A, val, pstream__);
}
// [[Rcpp::export]]
...
append_vec_2_val(const double& val, const Eigen::Matrix<double,-1,1>& A,
                 std::ostream* pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::append_vec_2_val(
           val, A, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
rowwise_mat_2_vec(const Eigen::Matrix<double,-1,-1>& A, std::ostream*
                  pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::rowwise_mat_2_vec(
           A, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
colwise_mat_2_vec(const Eigen::Matrix<double,-1,-1>& A, std::ostream*
                  pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::colwise_mat_2_vec(
           A, pstream__);
}
// [[Rcpp::export]]
...
state_space_model(const int& num_steps, const int& num_delays, const int&
                  ...
                  pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::state_space_model(
...
// [[Rcpp::export]]
 std::vector<stan::promote_args_t<stan::base_type_t<double>>> 
observed_mean(const int& n_rows, const int& num_delays,
              const Eigen::Matrix<double,-1,-1>& m,
              const std::vector<std::vector<int>>& case_idx, const int&
              s_col, const int& d_col, const int& t_col, std::ostream*
              pstream__ = 0) {
  return model1022a2e47765_User_defined_functions_namespace::observed_mean(
