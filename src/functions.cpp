...
namespace model2d886001b19_User_defined_functions_namespace {
...
create_block_diagonal(const Eigen::Matrix<double,-1,-1>& A,
                      ...
                      pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_block_diagonal(
           A, B, pstream__);
}
// [[Rcpp::export]]
...
rep_diagonal_mat(const Eigen::Matrix<double,-1,-1>& A, const int& k,
  ...
  return model2d886001b19_User_defined_functions_namespace::rep_diagonal_mat(
           A, k, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
rep_vec(const Eigen::Matrix<double,-1,1>& A, const int& k, std::ostream*
        pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::rep_vec(A, k,
           pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
rep_vec_piecewise(const Eigen::Matrix<double,-1,1>& A, const int& k,
                  std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::rep_vec_piecewise(
           A, k, pstream__);
}
// [[Rcpp::export]]
...
append_val_2_vec(const Eigen::Matrix<double,-1,1>& A, const double& val,
                 std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::append_val_2_vec(
           A, val, pstream__);
}
// [[Rcpp::export]]
...
append_vec_2_val(const double& val, const Eigen::Matrix<double,-1,1>& A,
                 std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::append_vec_2_val(
           val, A, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,-1> 
create_trend_matrix_block_A(const int& degree, std::ostream*
                            pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_trend_matrix_block_A(
           degree, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,1> 
create_trend_vector_block_L(const int& degree, std::ostream*
                            pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_trend_vector_block_L(
           degree, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,-1> 
create_trend_matrix_block_R(const int& degree, const int& is_constant,
                            std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_trend_matrix_block_R(
...
get_num_elements_alpha_trend(const int& degree, std::ostream*
                             pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::get_num_elements_alpha_trend(
           degree, pstream__);
}
// [[Rcpp::export]]
 int 
get_num_cols_A_trend(const int& degree, std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::get_num_cols_A_trend(
           degree, pstream__);
}
// [[Rcpp::export]]
 int 
get_num_rows_A_trend(const int& degree, std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::get_num_rows_A_trend(
           degree, pstream__);
}
// [[Rcpp::export]]
 int 
get_num_elements_L_trend(const int& degree, std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::get_num_elements_L_trend(
           degree, pstream__);
}
// [[Rcpp::export]]
 int 
get_num_cols_R_trend(const int& degree, std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::get_num_cols_R_trend(
           degree, pstream__);
}
// [[Rcpp::export]]
 int 
get_num_rows_R_trend(const int& degree, std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::get_num_rows_R_trend(
           degree, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,-1> 
create_seasonal_discrete_matrix_block_A(const int& num_seasons, const int&
                                        season_duration, std::ostream*
                                        pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_seasonal_discrete_matrix_block_A(
...
create_seasonal_discrete_vector_block_L(const int& num_seasons, const int&
                                        season_duration, std::ostream*
                                        pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_seasonal_discrete_vector_block_L(
           num_seasons, season_duration, pstream__);
}
// [[Rcpp::export]]
...
create_seasonal_discrete_matrix_block_R(const int& num_seasons, const int&
                                        ...
                                        std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_seasonal_discrete_matrix_block_R(
...
create_initial_seasonal_discrete_vector_block_alpha(const Eigen::Matrix<double,-1,1>&
                                                    ...
                                                    std::ostream*
                                                    pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_initial_seasonal_discrete_vector_block_alpha(
           season_params, season_duration, error_term, pstream__);
}
// [[Rcpp::export]]
 int  max_int(const int& a, const int& b, std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::max_int(a, b,
           pstream__);
}
// [[Rcpp::export]]
 int  min_int(const int& a, const int& b, std::ostream* pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::min_int(a, b,
           pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>,                 stan::base_type_t<double>>,-1,1> 
AR(const Eigen::Matrix<double,-1,-1>& y, const Eigen::Matrix<double,-1,1>&
  ...
  return model2d886001b19_User_defined_functions_namespace::AR(y, phi, t,
           pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>,                 stan::base_type_t<double>>,-1,1> 
MA(const Eigen::Matrix<double,-1,-1>& xi, const Eigen::Matrix<double,-1,1>&
  ...
  return model2d886001b19_User_defined_functions_namespace::MA(xi, theta, t,
           pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
create_phi_AR(const Eigen::Matrix<double,-1,1>& phi, std::ostream*
              pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_phi_AR(
           phi, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
create_theta_MA(const Eigen::Matrix<double,-1,1>& theta, std::ostream*
                pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::create_theta_MA(
           theta, pstream__);
}
// [[Rcpp::export]]
...
state_space_process(const int& num_steps, const int& num_delays, const int&
                    ...
                    pstream__ = 0) {
  return model2d886001b19_User_defined_functions_namespace::state_space_process(
