...
// Code generated by stanc v2.36.0-42-gc397822
...
int max_int(const T0__& a, const T1__& b, std::ostream* pstream__);
template <typename T0__, typename T1__,
          stan::require_all_t<std::is_integral<T0__>, std::is_integral<T1__>>* = nullptr>
int min_int(const T0__& a, const T1__& b, std::ostream* pstream__);
...
AR(const T0__& y_arg__, const T1__& phi_arg__, const T2__& t, const T3__& p,
...
Eigen::Matrix<stan::promote_args_t<stan::base_type_t<T0__>,
                stan::base_type_t<T1__>>,-1,1>
MA(const T0__& xi_arg__, const T1__& theta_arg__, const T2__& t, const T3__&
   q, std::ostream* pstream__);
...
template <typename T4__, typename T5__, typename T6__, typename T7__,
          ...
          stan::require_all_t<stan::is_col_vector<T4__>,
                              ...
                              stan::math::disjunction<stan::is_autodiff<T36__>,
                                                      std::is_floating_point<T36__>>,
                              stan::math::disjunction<stan::is_autodiff<T37__>,
                                                      std::is_floating_point<T37__>>,
...
template <typename T2__, typename T3__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T2__>,
                              ...
                              std::is_integral<stan::value_type_t<stan::value_type_t<T3__>>>>* = nullptr>
std::vector<stan::promote_args_t<stan::base_type_t<T2__>>>
get_val_for_model(const int& n_rows, const int& num_delays, const T2__&
                  m_arg__, const T3__& case_idx, const int& s_col, const int&
                  d_col, const int& t_col, std::ostream* pstream__);
template <typename T0__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
...
transform_state_space_model(const T0__& m_arg__, const T1__& identity_link,
                            const T2__& log_link, const T3__& softplus_link,
                            const T4__& dist_hyper_link, const T5__& k,
...
inv_normalize_cases(const std::vector<double>& normalized,
                    ...
                    const int& d_col, const int& s_col, const T7__& mu_arg__,
                    const T8__& sigma_arg__, std::ostream* pstream__);
template <typename T0__, typename T5__, typename T8__, typename T9__,
...
std::vector<
  std::vector<
    stan::promote_args_t<stan::base_type_t<T0__>, stan::base_type_t<T8__>,
      stan::base_type_t<T9__>>>>
inv_normalize_cases_2(const T0__& normalized_mat,
                      const std::vector<std::vector<int>>& case_idx,
                      const int& num_strata, const int& num_delays,
                      const int& num_steps, const T5__& tsize, const int&
...
// vector AR(matrix, vector, int, int)
template <typename T0__, typename T1__, typename T2__, typename T3__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T0__>,
                              stan::is_vt_not_complex<T0__>,
                              stan::is_col_vector<T1__>,
...
// vector MA(matrix, vector, int, int)
template <typename T0__, typename T1__, typename T2__, typename T3__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T0__>,
                              stan::is_vt_not_complex<T0__>,
                              stan::is_col_vector<T1__>,
...
// vector append_val_2_vec(vector, real)
template <typename T0__, typename T1__,
          stan::require_all_t<stan::is_col_vector<T0__>,
                              stan::is_vt_not_complex<T0__>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// vector append_vec_2_val(real, vector)
template <typename T0__, typename T1__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::is_col_vector<T1__>,
...
// vector rowwise_mat_2_vec(matrix)
template <typename T0__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T0__>,
                              stan::is_vt_not_complex<T0__>>*>
Eigen::Matrix<stan::promote_args_t<stan::base_type_t<T0__>>,-1,1>
...
// vector colwise_mat_2_vec(matrix)
template <typename T0__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T0__>,
                              stan::is_vt_not_complex<T0__>>*>
Eigen::Matrix<stan::promote_args_t<stan::base_type_t<T0__>>,-1,1>
...
/* matrix
   state_space_model(data int, data int, data int, data int, vector, vector,
                     vector, vector, vector, vector, data int, data int,
                     data int, data int, data int, data int, vector, vector,
                     vector, vector, vector, vector, data array[] int,
                     data array[] int, data array[] int, data array[] int,
                     data array[] int, data array[] int, data int, data int,
                     data int, data int, vector, vector, vector, vector, 
                     real, real, vector, vector, matrix, matrix, matrix, 
                     matrix)
 */
template <typename T4__, typename T5__, typename T6__, typename T7__,
          typename T8__, typename T9__, typename T16__, typename T17__,
...
/* array[] real
   get_val_for_model(data int, data int, matrix, array[,] int, data int,
                     data int, data int)
 */
template <typename T2__, typename T3__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T2__>,
                              ...
                              stan::is_std_vector<T3__>,
                              stan::is_std_vector<stan::value_type_t<T3__>>,
                              std::is_integral<stan::value_type_t<stan::value_type_t<T3__>>>>*>
std::vector<stan::promote_args_t<stan::base_type_t<T2__>>>
get_val_for_model(const int& n_rows, const int& num_delays, const T2__&
                  m_arg__, const T3__& case_idx, const int& s_col, const int&
                  d_col, const int& t_col, std::ostream* pstream__) {
...
// array[] real log_transform(data array[] real)
std::vector<double>
log_transform(const std::vector<double>& x, std::ostream* pstream__) {
  using local_scalar_t__ = double;
  int current_statement__ = 0;
...
// array[] real inv_log_transform(data array[] real)
std::vector<double>
inv_log_transform(const std::vector<double>& y, std::ostream* pstream__) {
  using local_scalar_t__ = double;
  int current_statement__ = 0;
...
// array[] real log1p_transform(data array[] real)
std::vector<double>
log1p_transform(const std::vector<double>& x, std::ostream* pstream__) {
  using local_scalar_t__ = double;
  int current_statement__ = 0;
...
// array[] real inv_log1p_transform(data array[] real)
std::vector<double>
inv_log1p_transform(const std::vector<double>& y, std::ostream* pstream__) {
  using local_scalar_t__ = double;
  int current_statement__ = 0;
...
// real softplus_transform(real, real)
template <typename T0__, typename T1__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// real inv_softplus_transform(real, real)
template <typename T0__, typename T1__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// array[] real softplus_transform(data array[] real, data real)
std::vector<double>
softplus_transform(const std::vector<double>& x, const double& k,
                   std::ostream* pstream__) {
  using local_scalar_t__ = double;
...
// array[] real inv_softplus_transform(data array[] real, data real)
std::vector<double>
inv_softplus_transform(const std::vector<double>& y, const double& k,
                       std::ostream* pstream__) {
  using local_scalar_t__ = double;
...
// real softplus1p_transform(real, real)
template <typename T0__, typename T1__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// real inv_softplus1p_transform(real, real)
template <typename T0__, typename T1__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// array[] real softplus1p_transform(data array[] real, data real)
std::vector<double>
softplus1p_transform(const std::vector<double>& x, const double& k,
                     std::ostream* pstream__) {
  using local_scalar_t__ = double;
...
// array[] real inv_softplus1p_transform(data array[] real, data real)
std::vector<double>
inv_softplus1p_transform(const std::vector<double>& y, const double& k,
                         std::ostream* pstream__) {
  using local_scalar_t__ = double;
...
// real dhyperbolic_transform(real, real, real)
template <typename T0__, typename T1__, typename T2__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// real inv_dhyperbolic_transform(real, real, real)
template <typename T0__, typename T1__, typename T2__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// array[] real dhyperbolic_transform(data array[] real, data real, data real)
std::vector<double>
dhyperbolic_transform(const std::vector<double>& x, const double& k,
                      const double& c, std::ostream* pstream__) {
  using local_scalar_t__ = double;
...
/* array[] real
   inv_dhyperbolic_transform(data array[] real, data real, data real)
 */
std::vector<double>
inv_dhyperbolic_transform(const std::vector<double>& y, const double& k,
                          const double& c, std::ostream* pstream__) {
...
// real dhyperbolic1p_transform(real, real, real)
template <typename T0__, typename T1__, typename T2__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// real inv_dhyperbolic1p_transform(real, real, real)
template <typename T0__, typename T1__, typename T2__,
          stan::require_all_t<stan::math::disjunction<stan::is_autodiff<T0__>,
                                                      std::is_floating_point<T0__>>,
                              stan::math::disjunction<stan::is_autodiff<T1__>,
...
// array[] real dhyperbolic1p_transform(data array[] real, data real, data real)
std::vector<double>
dhyperbolic1p_transform(const std::vector<double>& x, const double& k,
                        const double& c, std::ostream* pstream__) {
  using local_scalar_t__ = double;
...
/* array[] real
   inv_dhyperbolic1p_transform(data array[] real, data real, data real)
 */
std::vector<double>
inv_dhyperbolic1p_transform(const std::vector<double>& y, const double& k,
                            const double& c, std::ostream* pstream__) {
...
// matrix transform_state_space_model(matrix, int, int, int, int, real, real)
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T5__, typename T6__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T0__>,
                              stan::is_vt_not_complex<T0__>,
...
/* matrix
   count_cases(data array[,] int, data int, data int, data int, data int,
               data int)
 */
Eigen::Matrix<double,-1,-1>
count_cases(const std::vector<std::vector<int>>& case_idx, const int&
...
/* matrix
   mean_cases(data array[] real, data array[,] int, data int, data int,
...
/* matrix
   sd_cases(data array[] real, data array[,] int, data int, data int, data
  int,
            data int, data int)
 */
Eigen::Matrix<double,-1,-1>
...
/* array[] real
   normalize_cases(data array[] real, data array[,] int, data int, data int,
                   data int, data int, data int, matrix, matrix)
 */
template <typename T7__, typename T8__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T7__>,
                              stan::is_vt_not_complex<T7__>,
...
/* array[] real
   inv_normalize_cases(data array[] real, data array[,] int, data int,
                       data int, data int, data int, data int, matrix, 
                       matrix)
 */
template <typename T7__, typename T8__,
          stan::require_all_t<stan::is_eigen_matrix_dynamic<T7__>,
...
/* array[,] real
   inv_normalize_cases_2(array[,] real, data array[,] int, data int, data
  int,
                         data int, int, data int, data int, matrix, matrix)
 */
template <typename T0__, typename T5__, typename T8__, typename T9__,
          stan::require_all_t<stan::is_std_vector<T0__>,
                              stan::is_std_vector<stan::value_type_t<T0__>>,
...
public:
  ...
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.36.0-42-gc397822",
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      auto mu_intercept_centered =
        in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(tsize);
      ...
      auto nu_intercept_centered =
        in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(num_strata);
      ...
      auto sd_cycle =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
          jacobian__>(0, lp__, sd_cycle_1dim__);
      current_statement__ = 24;
      auto sd_ctilde =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
          jacobian__>(0, lp__, sd_ctilde_1dim__);
      current_statement__ = 25;
      auto sd_m =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
          jacobian__>(0, lp__, sd_m_1dim__);
      current_statement__ = 26;
      auto sd_dow_epi =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
          jacobian__>(0, lp__, sd_dow_epi_1dim__);
      current_statement__ = 27;
      auto sd_wkend_epi =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
          jacobian__>(0, lp__, sd_wkend_epi_1dim__);
      current_statement__ = 28;
      auto sd_dom_epi =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
          jacobian__>(0, lp__, sd_dom_epi_1dim__);
      current_statement__ = 29;
      auto sd_month_epi =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
          jacobian__>(0, lp__, sd_month_epi_1dim__);
      current_statement__ = 30;
      auto sd_week_epi =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
          jacobian__>(0, lp__, sd_week_epi_1dim__);
      current_statement__ = 31;
      auto sd_holidays_epi =
        in__.template read_constrain_lb<Eigen::Matrix<local_scalar_t__,-1,1>,
