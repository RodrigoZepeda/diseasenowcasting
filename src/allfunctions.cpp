...
namespace model310923325aa4b_User_defined_functions_namespace {
...
create_block_diagonal(const Eigen::Matrix<double,-1,-1>& A,
                      ...
                      pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_block_diagonal(
           A, B, pstream__);
}
// [[Rcpp::export]]
...
rep_diagonal_mat(const Eigen::Matrix<double,-1,-1>& A, const int& k,
  ...
  return model310923325aa4b_User_defined_functions_namespace::rep_diagonal_mat(
           A, k, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
rep_vec(const Eigen::Matrix<double,-1,1>& A, const int& k, std::ostream*
        pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::rep_vec(A, k,
           pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,-1> 
create_trend_matrix_block_A(const int& k, std::ostream* pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_trend_matrix_block_A(
           k, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,1> 
create_trend_vector_block_L(const int& k, std::ostream* pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_trend_vector_block_L(
           k, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,-1> 
create_trend_matrix_block_R(const int& k, const int& is_constant,
                            std::ostream* pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_trend_matrix_block_R(
...
create_initial_trend_vector_block_alpha(const Eigen::Matrix<double,-1,1>&
                                        alpha, std::ostream*
                                        pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_initial_trend_vector_block_alpha(
           alpha, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,-1> 
create_trend_matrix_A(const int& k, const int& d, std::ostream*
                      pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_trend_matrix_A(
           k, d, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<double,-1,-1> 
create_trend_matrix_R(const int& k, const int& is_constant, const int& d,
                      std::ostream* pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_trend_matrix_R(
...
create_trend_vector_L(const int& k, const int& d, std::ostream*
                      pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_trend_vector_L(
           k, d, pstream__);
}
// [[Rcpp::export]]
 Eigen::Matrix<stan::promote_args_t<stan::base_type_t<double>>,-1,1> 
create_trend_vector_alpha(const Eigen::Matrix<double,-1,1>& alpha,
                          std::ostream* pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::create_trend_vector_alpha(
           alpha, pstream__);
}
// [[Rcpp::export]]
 int 
get_num_elements_alpha_trend(const int& k, const int& d, std::ostream*
                             pstream__ = 0) {
  return model310923325aa4b_User_defined_functions_namespace::get_num_elements_alpha_trend(
           k, d, pstream__);
}
